...
const CANDIDATES: Candidate[] = [
  ...
  // — 3ª leva (base 365): reforço pesado de luto, solidão, alegria, culpa e propósito —
  { title: 'Aquieta Minh´alma', artist: 'Ministério Zoe', families: ['ansiedade', 'paz'] },
  { title: 'Ousado Amor', artist: 'Isaias Saad', families: ['culpa', 'solidão'] },
  { title: 'Me Ama', artist: 'Diante do Trono', families: ['culpa', 'gratidão'] },
  { title: 'Cura-me', artist: 'Fernanda Brum', families: ['luto', 'esperança'] },
  { title: 'Eu Sempre Estive Aqui', artist: 'Gerson Rufino', families: ['solidão', 'luto'] },
  { title: 'Identidade', artist: 'Anderson Freire', families: ['propósito'] },
  { title: 'Saudosa Lembrança', artist: 'Gerson Rufino', families: ['luto'] },
  { title: 'Deus', artist: 'Kleber Lucas', families: ['solidão', 'culpa'] },
  { title: 'Fiel a Mim', artist: 'Eyshila', families: ['fé', 'luto'] },
  { title: 'Deus de Promessas', artist: 'Toque no Altar', families: ['esperança', 'fé'] },
  { title: 'Marca da Promessa', artist: 'Trazendo a Arca', families: ['esperança'] },
  { title: 'Teu Santo Nome', artist: 'Gabriela Rocha', families: ['fé', 'gratidão'] },
  { title: 'Lindo És', artist: 'Juliano Son', families: ['gratidão', 'alegria'] },
  { title: 'Pode Morar Aqui', artist: 'Theo Rubia', families: ['paz', 'gratidão'] },
  { title: 'Bênçãos Que Não Têm Fim (Counting My Blessings)', artist: 'Isadora Pompeo', families: ['gratidão', 'alegria'] },
  { title: 'Fico Feliz', artist: 'Aline Barros', families: ['alegria'] },
  { title: 'Hino da Vitória', artist: 'Cassiane', families: ['fé', 'alegria'] },
  { title: '500 Graus', artist: 'Cassiane', families: ['alegria'] },
  { title: 'Dia de Sol', artist: 'Gerson Rufino', families: ['alegria', 'esperança'] },
  { title: 'Oh Quão Lindo Esse Nome É (What a Beautiful Name)', artist: 'Kemuel', families: ['alegria', 'gratidão'] },
  { title: 'Renova-me', artist: 'Aline Barros', families: ['propósito', 'culpa'] },
  { title: 'Rendido Estou', artist: 'Aline Barros', families: ['propósito', 'paz'] },
  { title: 'Minha Morada', artist: 'Isadora Pompeo', families: ['paz', 'solidão'] },
  { title: 'Tu És Fiel, Senhor', artist: 'Cassiane', families: ['gratidão', 'fé'] },
  { title: 'Eu Me Rendo', artist: 'Renascer Praise', families: ['propósito', 'culpa'] },
  { title: 'Yeshua', artist: 'Fernandinho', families: ['solidão', 'paz'] },
  { title: 'Ninguém Te Ama Como Eu', artist: 'Padre Marcelo Rossi', families: ['solidão'] },
  { title: 'Eu Sei Que Vem', artist: 'Isadora Pompeo', families: ['esperança', 'ansiedade'] },
  { title: 'Lázaro', artist: 'Eyshila', families: ['luto', 'esperança'] },
  { title: 'O Exilado', artist: 'Mattos Nascimento', families: ['solidão', 'esperança'] },
];
